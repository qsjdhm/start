...
public class TArticleService {
	...
	public List<TNote> queryOneNote(TNote note, Connection connetion)throws Exception{
	    ...
	    while(rs.next()) {  
	    	...
	    	System.out.println("转换钱：");
	    	System.out.println(rs.getObject("Article_Record"));
	...
	public int queryNoteLength(int typeId, Connection connetion)throws Exception{
		...
		String sql = "";
		if(typeId==0){
			sql = "select COUNT(*) from article_info where Sort_ID=1";  // 查询笔记所有的个数
		}else{  // 分类查询
			sql = "select COUNT(*) from article_info where Sort_ID=1 and Type_ID="+typeId;
		}
	...
	public List<TNote> pageQueryNote(int pageId, int pageCount, int typeId, Connection connetion)throws Exception{
		...
		String sql = "";
		if(typeId==0){
			sql = "select * from article_info where Sort_ID=1 order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
		}else{  // 分类查询
			sql = "select * from article_info  where Sort_ID=1 and Type_ID="+typeId +" order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
		}
	...
	// 推荐文章图书
	public boolean recommendNote(String idArr, Connection connetion)throws Exception{
		Statement statement = connetion.createStatement();
		...
		// 删除多条数据
		insql = new StringBuffer("update article_info set Recommend_Num=1, Recommend_Date='"+pNowDate+"' where Article_ID in("+idArr+")");
	    int inrs = statement.executeUpdate(insql.toString());  
	    statement.close();
	    if(inrs>0){
	    	return true;
	...
	// 查询图书的个数
	public int queryLikeLableLength(String lableName, Connection connetion)throws Exception{
		int length = 0;
		Statement statement = connetion.createStatement();
		
		// 根据分类Id查出此分类下的个数
		String sql = "select COUNT(*) from article_info where Aarticle_Label like '%"+lableName+"%'";  // 查询笔记所有的个数
	...
	// 查询标签在文章标签中的数据
	public List<TNote> pageLableInArticle(int pageId, int pageCount, String lableName, Connection connetion)throws Exception{
		...
		String sql = "select * from article_info where Aarticle_Label like '%"+lableName +"%' order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
	...
	// 查询文章和关键字匹配的个数
	public int queryLikeKeywordLength(String keyword, Connection connetion)throws Exception{
		int length = 0;
		Statement statement = connetion.createStatement();
		
		// 根据分类Id查出此分类下的个数
		String sql = "select COUNT(*) from article_info where Article_Title like '%"+keyword+"%' or Article_Text like '%"+keyword+"%' or Aarticle_Label like '%"+keyword+"%'";  // 查询笔记所有的个数
		System.out.println(sql);  
	    ResultSet rs = statement.executeQuery(sql);  
	...
	// 查询文章和关键字匹配的数据
	public List<TNote> queryLikeKeyword(int pageId, int pageCount, String keyword, Connection connetion)throws Exception{
		
		Statement statement = connetion.createStatement();
		
		List<TNote> noteList = new ArrayList();
		
		String sql = "select * from article_info where Article_Title like '%"+keyword+"%' or Article_Text like '%"+keyword+"%' or Aarticle_Label like '%"+keyword+"%' order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
	...
	// 查询一个笔记的内容
	public List<TNote> queryOneNoteP(TNote note, Connection connetion)throws Exception{
	...
	// 查询图书的个数
	public int queryNoteLengthP(int type, Connection connetion)throws Exception{
		int length = 0;
		Statement statement = connetion.createStatement();
		...
		String sql = "";
		if(type==0){
			sql = "select COUNT(*) from article_info";  // 查询笔记所有的个数
		}else{
			sql = "select COUNT(*) from article_info where Type_ID ="+type;  // 查询笔记分类的个数
		}
	...
	// 查询笔记分页
	public List<TNote> pageQueryNoteP(int type, int pageId, int pageCount, Connection connetion)throws Exception{
		...
		if(type==0){
			sql = "select * from article_info order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
		}else{
			sql = "select * from article_info  where Type_ID="+type +" order by Article_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
		}
	...
	// 查询图书的个数
	public int queryRecomLength(Connection connetion)throws Exception{
		int length = 0;
		Statement statement = connetion.createStatement();
		
		// 根据分类Id查出此分类下的个数
		String sql = "select COUNT(*) from article_info where Sort_ID=1 and  Recommend_Num = 1";  // 查询笔记分类的个数
	...
	// 查询图书的个数
	public int queryNewNoteRecomLength(Connection connetion)throws Exception{
		int length = 0;
		Statement statement = connetion.createStatement();
		
		// 根据分类Id查出此分类下的个数
		String sql = "select COUNT(*) from article_info where Sort_ID=2 and  Recommend_Num = 1";  // 查询笔记分类的个数
	...
	// 查询推荐文章数据
	public List<TNote> queryRecomData(int pageId, int pageCount, Connection connetion)throws Exception{
		
		Statement statement = connetion.createStatement();
		
		List<TNote> noteList = new ArrayList();
		String sql = "select * from article_info where Sort_ID=1 and Recommend_Num=1 order by Recommend_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
	...
	// 查询推荐文章数据
	public List<TNote> queryNewNoteRecomData(int pageId, int pageCount, Connection connetion)throws Exception{
		
		Statement statement = connetion.createStatement();
		
		List<TNote> noteList = new ArrayList();
		String sql = "select * from article_info where Sort_ID=2 and Recommend_Num=1 order by Recommend_Date desc limit "+ pageCount*(pageId-1) + " , " + pageCount;
	...
	// 查询推荐笔记数据
	public List<TNote> queryRecomNoteData(Connection connetion)throws Exception{
		...
		String sql = "select * from article_info where Sort_ID=2 and Recommend_Num=1 order by Recommend_Date desc limit 0 , 5";
